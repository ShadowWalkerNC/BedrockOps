...
export type NavKey = 'dashboard' | 'diagnostics' | 'setup' | 'console' | 'players' | 'plugins' | 'marketplace' | 'worlds' | 'settings';
...
const NAV: NavDef[] = [
  ...
  { key: 'diagnostics', label: 'Diagnostics & Health', href: '/diagnostics' },
